...
const state={tab:'home',watchlist:load(WATCHLIST_KEY,[]),selected:load(SELECTED_KEY,DEFAULTS.map(x=>x.symbol)),period:'1mo',detailSymbol:null,valuationMetric:'forwardPE',watchSort:'manual',newsSort:'major'};
